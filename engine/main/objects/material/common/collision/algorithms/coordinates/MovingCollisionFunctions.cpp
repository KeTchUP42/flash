...
Material::pickoutNodulesY(const Possibilities::PhysicallySituated &object, const std::pair<float, float> &ordinateVerge, bool moveSide) noexcept {
...
std::vector<Components::Point>
Material::pickoutNodulesX(const Possibilities::PhysicallySituated &object, const std::pair<float, float> &abscissaVerge, bool moveSide) noexcept {
    std::vector<Components::Point> pointsOffset;
