...
#include "../../../../static/triggers/impact/mobs/handlers/DeathMobsHandler.h"
...
load(const IniUtil::Analyzer::IniBlock &data, Unite::Unifier &unifier, View::Window &window) {
    unifier.addTrigger(new Triggers::ImpactMobsTrigger(commonArea(data), new Triggers::DeathMobsHandler()));
}
