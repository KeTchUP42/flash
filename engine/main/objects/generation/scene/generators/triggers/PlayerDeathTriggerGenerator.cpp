...
#include "../../../../static/triggers/impact/player/handlers/DeathPlayerHandler.h"
...
load(const IniUtil::Analyzer::IniBlock &data, Unite::Unifier &unifier, View::Window &window) {
    unifier.addTrigger(new Triggers::ImpactPlayerTrigger(commonArea(data), new Triggers::DeathPlayerHandler()));
}
